import { GestureResponderEvent, Modal, Text, TouchableOpacity, TouchableWithoutFeedback, View } from "react-native";
...
export const Menu = () => {
    ...
    return (
      <View style={styles.container}>
            ...
            <TouchableWithoutFeedback onPress={clickOutside}>
                <View style={styles.modalOverlay}>
                    <View style={styles.menu}>
                      <TouchableOpacity onPress={handleAddTable} style={styles.menuItem}>
                          <Text style={styles.menuText}>Добавить стол</Text>
                      </TouchableOpacity>
                      <TouchableOpacity onPress={handleCloseShift} style={styles.menuItem}>
        ...
        {isAddTableVisible && (
              <ModalAddTable 
                onClose={() => setIsAddTableVisible(false)} 
              />
            )}
      </View>
)
